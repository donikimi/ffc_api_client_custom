...
USGSGage <- R6::R6Class("USGSGage", list(
  ...
  end_date = "",
  gage_fail_years_data = "", # edit by DhKim: Syncronize with FFCprocessor$fail_years_data. Go to line 100.
  ...
  get_data = function(){
    ...
    if(usgs_daily$yr_total>self$gage_fail_years_data){ # edit by DhKim: USGSGage$gage_fail_years_data is same as FFCprocessor$fail_years_data. No longer hardcoded to 10 yrs.
        ...
        futile.logger::flog.warn(paste0("Custom: Less than ", self$gage_fail_years_data, " years of data...try again")) #  edit by DhKim
        return(NULL)
      }
